...
<?php
    foreach ($torrents as $row) {
        ...
        print("<td align=center>" . $row["downloaded"] . "</td>\n");

        print("<td align=right><b><a href=details.php?id=".$row["torrent_hash"]."&amp;hit=1&amp;tocomplete=1>" . $row["complete"] . "</a></b></td>\n");

                print("<td align=right>".$row["downloading"]."</b></td>\n");
		print("<td align=center>".$row["transferred"]."</td>");
        print("</tr>\n");
    }
