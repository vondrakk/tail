...
if (isset($CURUSER)) {
	...
	if ($count > 0) {
		...
		if( $arr = mysql_fetch_assoc($res) ) {
			...
			print("</td></tr></table>");
	 		if ($voted) print("<p align=center><a href=polls.php>Previous polls</a></p>\n"); ?>
			print("</td></tr></table>");
...
<tr><td class=rowhead>Online Since</td><td align=right><?php=$config['onlinesince']?></td></tr>
<tr><td class=rowhead>Registered users</td><td align=right><?php=$registered?></td></tr>
<!-- <tr><td class=rowhead>Unconfirmed users</td><td align=right><?php=$unverified?></td></tr> -->
<tr><td class=rowhead>Torrents</td><td align=right><?php=$torrents?></td></tr>
<?php if (isset($peers)) { ?>
	<tr><td class=rowhead>Peers</td><td align=right><?php=$peers?></td></tr>
	<tr><td class=rowhead>Seeders</td><td align=right><?php=$seeders?></td></tr>
	<tr><td class=rowhead>Leechers</td><td align=right><?php=$leechers?></td></tr>
	<tr><td class=rowhead>Seeder/leecher ratio (%)</td><td align=right><?php=$ratio?></td></tr>
	<tr><td class=rowhead>Total Downloaded</td><td align=right><?php=mksize($totaldownloaded)?></td></tr>
	<tr><td class=rowhead>Total Uploaded</td><td align=right><?php=mksize($totaluploaded)?></td></tr>
<?php } ?>
</table>
</td></tr></table>
